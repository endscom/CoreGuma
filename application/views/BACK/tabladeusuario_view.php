...
<div class="">
    ...
    <div class="row">
        <div class="col s12">
          <div class="card">
            <h5 class="center Texto"><br>USUARIOS</h5>
            <div class="card-content">
              <div class="row" id="Btns">
              <a  id="btn" class="waves-effect waves-light btn" href="<?php echo base_url('index.php/Ingreso');?>">CREAR</a> &nbsp&nbsp
              <a  id="btn" class="waves-effect waves-light btn red " href="<?php echo base_url('index.php/dashboard');?>">CANCELAR</a> <br><br>
              </div>
              <div>
                            ...
                            foreach ($MTUS as $key) {
                               echo "
                                <tr>                                    
                                    ...
                                    <td><a href='".base_url('index.php/Eliminar/'.$key['SlpCode'].'')."'><i class='red-text  material-icons'>&#xE5CD;</i>
                                    </a></td>                                    
                                </tr>
                                ";
                                $c++;
