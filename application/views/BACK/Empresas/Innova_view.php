	...
	<div class="col s12">
		...
		<div class="row">
            ...
            <div class="row" >
            	...
            	<div class="col s6">
			        	<a  id="back2" href="<?php echo base_url()?>/index.php/dashboard" class="waves-effect waves-light btn" >REGRESAR</a>
			        </div>
           	        
            	<div class=" col s6">
			        	 <a onclick="generarPdf();" id="pdf2" class="waves-effect waves-light btn" >PDF</a>
			        </div>
		...
		<table id="TblInnova" class=" table bordered hover  display" >
			...
			<div>
				<p id="actualizar2">Última actualización: <?php echo $MTMV[0]['LastUpdate']; ?>
				</p>
			</div>
	</div>
</div>
