...
<div class="row">
	<div class="col s12">
		...
		<div class="row">
            ...
            <div class="row" >
            		...
            		<div class="col s1">
            			...
            			{ 
            			   echo "<a onclick='generarPdf();'' id='pdf1' class='waves-effect waves-light btn' >PDF</a>";
						}
            		?>
        ...
        <br>
		<table id="TblUMA" class=" table bordered hover  display" >
			<thead >
				<tr>
				 	<td id="Cordoba2"colspan="13">C&Oacute;RDOBAS</td>					
				</tr>
				<tr >
					<th>CUENTA</th>
					<th>MONEDA</th>
			...
			<tbody>
				...
				<tr>
					<table id="TblUMAD"  class="table bordered hover  display" >
						<thead>
							<tr><td colspan="13" id="Dolar2">D&Oacute;LARES </td></tr>
							<tr>
								<th>CUENTA</th>
								<th>MONEDA</th>
								<th>TIPO CUENTA Cte.</th>
			...
			<div>
				<p id="actualizar1">Última actualización:<?php echo date('d/m/Y',strtotime(substr($MTMV[0]['LastUpdate'], 0,10))); ?>
				</p>
			</div>
	</div>
</div>
