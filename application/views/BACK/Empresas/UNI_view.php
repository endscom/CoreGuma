		...
		<div class="row">
            ...
            <div class="row" >
            	...
            	<div class=" col s1">
						...
						{
							echo "<a onclick='generarPdf();'' id='pdf' class='waves-effect waves-light btn' >PDF</a>";
						}
			        	 ?>
		...
		<table id="tblid_vista_detalles" class=" table bordered hover  display" >
			<thead >
				...
				<tr >
					...
					<th>MOv. EGR. CHKC</th>
					<th>MOV. EGR. ND</th>					
					<th>SALDOS EN LIBROS AL <br><?php echo date('d/m/Y',strtotime(substr($MTMV[0]['FechaM'], 0,10)));?></th>
					<th>CHEQUES FLOTANTES</th>
					<th>SALDO EN BANCOS AL <br><?php echo date('d/m/Y',strtotime(substr($MTMV[0]['FechaM'], 0,10))); ?></th>
					<th>DEPOSITOS NO DISPONIBLES</th>
					<th>DISPONIBLE REAL AL <br><?php echo date('d/m/Y',strtotime(substr($MTMV[0]['FechaM'], 0,10))); ?></th>
				</tr>
			</thead>
			<tbody>
